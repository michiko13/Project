    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div>
                    <img class="rounded-circle" src="img/logo.jpg" style="height: 35px; border-right: 1px solid #333 " >
                </div>
                <div class="sidebar-brand-text mx-2">Project</div>
            </a>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="img/profile-icon.png" alt="...">
                <p class="text-center mb-2"><strong>Project</strong> Vestibulum ligula sit amet nulla viverra faucibus</p>
                <a class="btn btn-success btn-sm" href="#">Sample</a>
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="img/profile-icon.png">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div><h6>Welcome {{ Auth::user()->name}}!</h6></div>
